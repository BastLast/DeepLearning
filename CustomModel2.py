...
class CustomModel2(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=512, kernel_size=3, stride=1, padding=1, bias=False)
        self.relu1 = nn.ReLU()

        self.conv2 = nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=False)
        self.relu2 = nn.ReLU()
        """
        ...
        self.conv6 = nn.Conv2d(in_channels=512, out_channels=3, kernel_size=3, stride=1, padding=1, bias=False)
